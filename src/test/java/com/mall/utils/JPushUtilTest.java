...
public class JPushUtilTest {
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(JPushUtilTest.class);

    // demo App defined in resources/jpush-api.conf
    private static final String appKey ="12897b3b2bd0f9b8fbffc06e";
    private static final String masterSecret = "ed2cd6d652350b609adff171";
...
//            jpushClient.close();
    ...
    public static PushPayload buildPushObject_all_alias_alert() {
        return PushPayload.newBuilder()
                ...
                .setAudience(Audience.alias("13575762817"))

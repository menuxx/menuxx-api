...
public class OrderWrapperImpl implements OrderWrapper {
    ...
    private Order pushOrder(Order order) {
        ...
        try {
            ...
            logger.info("------ PhoneList", phoneList);
            logger.info("------ getYunBaAppKey", appConfiguration.getYunBaAppKey());
            logger.info("------ getYunBaSecretKey", appConfiguration.getYunBaSecretKey());
